      ...
      <Wrapper>
        <Group title="Color Props">
          <Item name="fill" type="string" default={`"base"`} description={(<>
            Sets line color from Opium.Fill scheme or custom variable from <Code inline>config.customVariables</Code> See <Link href="/intro/colors">colors</Link> fro more information
            </>)}
          >
