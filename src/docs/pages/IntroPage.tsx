...
import { Box, Font, Gap, Fit, Line, Align, useTheme } from '../../themeor'
...
export default function IntroPage(props: IntroPageProps) {
  ...
  const handleGettingStarted = (e: any) => {
    const { history } = props
      ...
      <Gap hor="x3l">
        ...
        <Font align="center" >
          <Align hor="center" >
            ...
            <Gap size="lg" />
            <Align row>
              <Button.Primary onClick={handleGettingStarted}>Get Started</Button.Primary>
              <Gap />
              <Button onClick={handleDemo}>Check out demo</Button>
            </Align>
